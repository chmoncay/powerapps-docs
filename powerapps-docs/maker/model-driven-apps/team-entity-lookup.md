...
search.app: 
  ...
  - D365CE
---
# Add entities as lookup options in your app

With Unified Interface apps, for entities to be available in a lookup it must be added to the app. For example, contact records have the ability to be assigned to a user or a team.  
